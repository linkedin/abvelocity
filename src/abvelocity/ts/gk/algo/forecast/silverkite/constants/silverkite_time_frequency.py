...
class SilverkiteTimeFrequencyEnum(Enum):
    ...
    frequencies in `~blah.greykite.common.enums.SimpleTimeFrequencyEnum`.
    """
    ...
    # yearly
    YEAR: SilverkiteFrequency = SilverkiteFrequency(name=FrequencyEnum.YEAR, auto_fourier_seas={})

    # longer than yearly
    MULTIYEAR: SilverkiteFrequency = SilverkiteFrequency(name=FrequencyEnum.MULTIYEAR, auto_fourier_seas={})
