...
class SilverkiteComponentsEnum(Enum):
    ...
    DAILY_SEASONALITY: SilverkiteComponent = SilverkiteComponent(groupby_time_feature=TimeFeaturesEnum.tod.value, xlabel="Hour of day", ylabel="daily")

    WEEKLY_SEASONALITY: SilverkiteComponent = SilverkiteComponent(groupby_time_feature=TimeFeaturesEnum.tow.value, xlabel="Day of week", ylabel="weekly")

    MONTHLY_SEASONALITY: SilverkiteComponent = SilverkiteComponent(groupby_time_feature=TimeFeaturesEnum.tom.value, xlabel="Time of month", ylabel="monthly")
    ...
    YEARLY_SEASONALITY: SilverkiteComponent = SilverkiteComponent(groupby_time_feature=TimeFeaturesEnum.toy.value, xlabel="Time of year", ylabel="yearly")
