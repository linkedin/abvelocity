...
class ComputationParam:
    ...
    def from_dict(obj: Any) -> "ComputationParam":
        ...
        return ComputationParam(hyperparameter_budget=hyperparameter_budget, n_jobs=n_jobs, verbose=verbose)
...
class EvaluationMetricParam:
    ...
    """See `score_func` in :func:`~blah.greykite.framework.pipeline.pipeline.forecast_pipeline`."""
...
class ModelComponentsParam:
    ...
    def from_dict(obj: Any) -> "ModelComponentsParam":
        ...
        hyperparameter_override = from_union(
            ...
            obj.get("hyperparameter_override"),
        )
...
class ForecastConfig:
    ...
    See :class:`~blah.greykite.sklearn.estimator.one_by_one_estimator.OneByOneEstimator`.
    ...
    See :class:`~blah.greykite.framework.templates.autogen.forecast_config.ModelComponentsParam`.
    """
    ...
    See :class:`~blah.greykite.framework.templates.model_templates.ModelTemplateEnum`
    for valid names.
    """
...
def assert_equal_forecast_config(forecast_config_1: ForecastConfig, forecast_config_2: ForecastConfig):
    ...
    forecast_config_1: `ForecastConfig`
        ...
        :class:`~blah.greykite.framework.templates.model_templates.ForecastConfig` for comparing.
