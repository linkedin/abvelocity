...
from abvelocity.ts.gk.algo.forecast.silverkite.constants.silverkite_seasonality import SilverkiteSeasonalityEnum
...
from abvelocity.ts.common.enums import FrequencyEnum, SeasonalityEnum
...
def test_simple_silverkite_constants():
    ...
    assert silverkite._silverkite_holiday.HOLIDAY_LOOKUP_COUNTRIES_AUTO == ("UnitedStates", "UnitedKingdom", "India", "France", "China")
