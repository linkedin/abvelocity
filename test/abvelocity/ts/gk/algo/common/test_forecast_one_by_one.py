import pandas as pd
from abvelocity.ts.gk.algo.common.forecast_one_by_one import forecast_one_by_one_fcn
...
def test_forecast_one_by_one_fcn():
    ...
    forecast1 = train_forecast_func(df=df, value_col="y", time_col="ts", forecast_horizon=7)
    ...
    forecast2 = forecast_one_by_one_fcn(train_forecast_func)(df=df, value_col="y", time_col="ts", forecast_horizon=7)
    ...
    forecast3 = forecast_one_by_one_fcn(train_forecast_func, df=df, time_col="ts", forecast_horizon=7)(value_col="y")
