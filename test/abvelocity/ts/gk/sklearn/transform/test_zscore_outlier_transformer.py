...
def test_zscore_outlier_transformer1(data):
    ...
    zscore_transform = ZscoreOutlierTransformer(z_cutoff=2.0, use_fit_baseline=True)
    ...
    zscore_transform = ZscoreOutlierTransformer(z_cutoff=2.0, use_fit_baseline=False)
    result = zscore_transform.transform(test_data)
