...
from abvelocity.ts.gk.framework.benchmark.benchmark_template import (
...
from abvelocity.ts.gk.framework.templates.autogen.forecast_config import EvaluationMetricParam, MetadataParam
...
def test_benchmark_silverkite_template_with_simulated_data():
    ...
    max_cvs = [3]
    fit_algorithms = ["ridge"]  # "linear" (statsmodels OLS) crashes pytest-xdist worker on Linux (SVD instability)
    ...
    assert result_silverkite_simulated["forecast_model_name"] == "silverkite_ridge"
