from abvelocity.ts.common.enums import SeasonalityEnum, SimpleTimeFrequencyEnum, TimeEnum
...
def test_simple_time_frequency_enum():
    ...
    assert SimpleTimeFrequencyEnum.MONTH.value.valid_seas == {SeasonalityEnum.QUARTERLY_SEASONALITY.name, SeasonalityEnum.YEARLY_SEASONALITY.name}
